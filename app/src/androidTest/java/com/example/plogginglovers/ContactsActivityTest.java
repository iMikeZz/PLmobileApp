...
public class ContactsActivityTest {
    ...
    public void contactsActivityTest() {
        ...
        ViewInteraction materialCardView = onView(
                allOf(withId(R.id.contacts_card),
                        childAtPosition(
        ...
        DataInteraction relativeLayout = onData(anything())
                .inAdapterView(allOf(withId(R.id.contactsList),
                        childAtPosition(
        ...
        onView(withText("Ligar")).check(matches(isDisplayed()));


        ViewInteraction materialButton2 = onView(
                allOf(withId(android.R.id.button3), withText("Voltar"),
                        childAtPosition(
                                childAtPosition(
